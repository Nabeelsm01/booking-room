...
background: linear-gradient(158deg, rgba(255,32,32,1) 0%, rgba(172,10,10,1) 100%);"><i class="bi bi-box-arrow-right"></i><span> Logout</span></a>
    ...
    <div class="main-content" id="mainContent">
        <!-- Header -->
        <div class="header">
            <div class="logo" style="font-size:22px;">ระบบจัดการรายการอาหาร</div>
            <div class="notification">.</div>
        </div>

        <!-- Dashboard Content -->
        <div class="section">
            <h3>สรุปรายการอาหาร</h3>
            <div class="card">
                <p>แสดงจำนวนรายการอาหาร</p>
                   ...
                   // ดึงข้อมูลจากฐานข้อมูล
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='meetingroom_edit.php?id=" . $row["id_food"] . "' class='edit-button'>แก้ไข</a></td>";
                            // echo "<td><a href='meetingroom_delete.php?id=" . $row["id_room"] . "' class='delete-button'>ลบ</a></td>";
                            echo "<td><a href='#' onclick='confirmDelete(" . $row["id_food"] . ")' class='delete-button'>ลบ</a></td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
