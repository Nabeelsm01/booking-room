...
background: linear-gradient(158deg, rgba(255,32,32,1) 0%, rgba(172,10,10,1) 100%);"><i class="bi bi-box-arrow-right"></i><span> Logout</span></a>
    ...
    <div class="main-content" id="mainContent">
        <!-- Header -->
        <div class="header">
            <div class="logo" style="font-size:22px;">ระบบจัดการการชำระเงิน</div>
        ...
        JOIN details_roombooking ON roombooking.id_bookingroom = details_roombooking.id_bookingroom 
        JOIN meetingroom ON details_roombooking.id_room = meetingroom.id_room 
        GROUP BY payment_room.id_bookingroom
        ORDER BY payment_room.id_paymentroom DESC";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='meetingroom_edit.php?id=" . $row["id_paymentroom"] . "' class='edit-button'>แก้ไข</a></td>";
                            // echo "<td><a href='meetingroom_delete.php?id=" . $row["id_room"] . "' class='delete-button'>ลบ</a></td>";
                            echo "<td><a href='#' onclick='confirmDelete(" . $row["id_paymentroom"] . ")' class='delete-button'>ลบ</a></td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
