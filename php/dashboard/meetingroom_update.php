...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['image_room']['name'])) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            header("Location: meetingroom_edit.php?id=" . $id_room); // เปลี่ยนเส้นทางกลับไปยังหน้าที่ยืนยัน
            exit();
        }
    ...
    header("Location: meetingroom_admin.php"); // เปลี่ยนเส้นทางไปยังหน้าห้องประชุม
    exit();
}
?>
