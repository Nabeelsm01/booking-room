...
<body>
    ...
    <?php endif; ?>
    <h2>แก้ไขคอร์สติว edit Course</h2>
    <?php
...
if (isset($_SESSION['id_tutor'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            // แบบง่ายที่สุด
            echo "<td>" . "<a href='" . htmlspecialchars($row["flie_doc"]) . "' target='_blank'>" 
            . htmlspecialchars($row["label_doc"]) 
            . "</a>" ."</td>";
            echo "<td><a href='edit_formcourse.php?id=" . $row["id_course"] . "' class='edit-button'>แก้ไข</a></td>";
            echo "</tr>";
        }
        echo "</tbody>";
        echo "</table>";
