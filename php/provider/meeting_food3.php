...
<body>
    ...
    <div class="allblockcenter">
        <div class="blockcenter">
            ...
            <button class="btn-food" onclick="window.location.href='meeting_food2.php'"><i class="bi bi-stack-overflow"></i> อาหารว่าง</button>
            <button class="btn-food" onclick="window.location.href='meeting_food3.php'" style="background-color: #dce6ff;"><i class="bi bi-cup-straw"></i> เครื่องดื่ม</button>
