...
<body>
    <a href="meetingroom.php" class="turn-btn">ย้อนกลับ</a>
...
if (isset($_SESSION['id_provider'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row["detail_room"] . "</td>";
            echo "<td>" . $row["opacity_room"] . "</td>";
            echo "<td>" . $row["price_room"] . "</td>"; 
            echo "<td>" . $row["room_type"] . "</td>"; 
            echo "<td>" . $row["address_room"] . "</td>";
           // echo "<td><a href='delete_db.php?id=" . $row["id_room"] . "' class='delete-button'>ลบ</a></td>";
           echo "<td>
           <a href='#' class='delete-button' data-toggle='modal' data-target='#deleteModal" . $row["id_room"] . "'>ลบ</a>
   
           <div class='modal fade' id='deleteModal" . $row["id_room"] . "' tabindex='-1' role='dialog' aria-labelledby='deleteModalLabel' aria-hidden='true'>
               <div class='modal-dialog' role='document'>
                   <div class='modal-content'>
                       ...
                       <div class='modal-footer'>
                           ...
                           <a href='delete_db.php?id=" . $row["id_room"] . "' class='btn btn-danger'>ลบ</a>
                       </div>
                   </div>
               </div>
           </div>
